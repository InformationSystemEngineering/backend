...
VALUES (3, 'zarkokn@gmail.com', 'Knezevic', 'Nina', '$2y$10$HgilFq.14RicLfcPGKBOYeuplIU.wTz1NbYeSuY5fblX4TWkUj8UW', 'student1');

INSERT INTO student(id, faculty_name)
VALUES (2, 'Psiholoski fakultet NS');

INSERT INTO users(role_id, email, last_name, name, password, username)
VALUES (3, 'student2@gmail.com', 'Boskovic', 'Ana', '$2y$10$XeHBUEM6tbR2LFj8VaBuz.yv1QSdn8X0vVidt/3Yais4mA8oBLyT2', 'student2');

INSERT INTO student(id, faculty_name)
VALUES (3, 'Privatni psiholoski fakultet BG');

INSERT INTO users(role_id, email, last_name, name, password, username)
VALUES (3, 'student3@gmail.com', 'Jovic', 'Helena', '$2y$10$4i0YzRS1wnkHSR6KdHb.aeYD7/agdp4TLyMm0ZguS2/2MosBcrfee', 'student3');
...
INSERT INTO internship_test (max_points, date, time, internship_id)
VALUES (100, '2024-09-20', null, 1);

INSERT INTO internship_test (max_points, date, time, internship_id)
VALUES (100, '2024-10-25', '10:00:00', 2);
...
INSERT INTO users(
    role_id, email, last_name, name, password, username)
VALUES (5, 'menadzer@gmail.com', 'Lazic', 'Ana', '$2y$10$tQTm6Mf6G93ftNmf.NuFb.37OwqSRAII9bqgvIOaU3P45SxxgOrFO', 'menadzer');
